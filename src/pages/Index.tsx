  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero section with increased transparency */}
        <section className="relative py-20 overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center animate-fade-in glass dark:glass-dark p-8 rounded-2xl">
              <div className="inline-block p-2 px-3 bg-feedr/20 rounded-full text-feedr mb-4">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/register">
                  <Button size="lg" className="w-full sm:w-auto btn-transparent">
                    Share Food
                  </Button>
                </Link>
                
                <Link to="/register">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto bg-white/10 dark:bg-black/10">
                    Find Food
                  </Button>
                </Link>
              </div>
        ...
        {/* How it works - with transparent cards */}
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center mb-12 glass dark:glass-dark p-6 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass dark:glass-dark p-6 rounded-lg shadow-sm flex flex-col items-center text-center">
                <div className="p-4 bg-feedr-muted/80 rounded-full mb-4">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4 glass dark:glass-dark p-4 rounded-lg">
                <div className="p-2 bg-feedr-muted/70 rounded-full h-fit">
        ...
        {/* CTA - with enhanced transparency */}
        <section className="py-20 bg-feedr/80 backdrop-blur-md text-feedr-foreground">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <Link to="/register">
                <Button size="lg" variant="secondary" className="bg-white/80 hover:bg-white/90 text-feedr">
                  Get Started Now
                </Button>
              </Link>
            </div>
      ...
      <footer className="glass dark:glass-dark border-t py-8">
        <div className="container mx-auto px-6">
